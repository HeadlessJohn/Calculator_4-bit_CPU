...
module control_block(
    ...
    wire nop, outb, outs, add_s, sub_s, and_s, shl, clr_s, psah, shr, load, jz,
         jmp, jge, div_s, mul_s, 
         mov_ah_cr, mov_ah_dr, mov_tmp_ah, mov_tmp_br, mov_tmp_cr, mov_tmp_dr,
         mov_tmp_rr, mov_cr_ah, mov_cr_br, mov_dr_ah, mov_dr_tmp, mov_dr_br,
         mov_rr_ah, mov_key_ah, mov_inr_tmp, mov_inr_rr;
    inst_decoder i_decoder(
        ir_in,
        nop, outb, outs, add_s, sub_s, and_s, shl, clr_s, psah, shr, load, jz,
        jmp, jge, div_s, mul_s, 
        mov_ah_cr, mov_ah_dr, mov_tmp_ah, mov_tmp_br, mov_tmp_cr, mov_tmp_dr,
        mov_tmp_rr, mov_cr_ah, mov_cr_br, mov_dr_ah, mov_dr_tmp, mov_dr_br,
        mov_rr_ah, mov_key_ah, mov_inr_tmp, mov_inr_rr);
...
module control_signal(
    input [11:0] t,
    input nop, outb, outs, add_s, sub_s, and_s, shl, clr_s, psah, shr, load, jz,
        jmp, jge, div_s, mul_s, 
        mov_ah_cr, mov_ah_dr, mov_tmp_ah, mov_tmp_br, mov_tmp_cr, mov_tmp_dr,
        mov_tmp_rr, mov_cr_ah, mov_cr_br, mov_dr_ah, mov_dr_tmp, mov_dr_br,
        mov_rr_ah, mov_key_ah, mov_inr_tmp, mov_inr_rr,
